...
3. Minimum and maximum number of SECs: contains the ILP models of the c_min and c_max
	2.1. cmin: contains the c_min model
	2.2. cmax: contains the c_max model

4. ML proof of concept: contains the codes to generate Table 7 and Table 8. (Note the size of the bitset has to be set before compilation. We used 2000.)
	3.1. Random: contains the code to generate Table 7.
	3.2. MST_RC: contains the code to generate Table 8. 
	
5. Cycle generation algorithms: contains the codes to generate Table 9 and 10.
